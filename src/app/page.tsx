...
export default function LoginPage() {
  ...
  // While authentication is loading, show a loading screen.
  // This prevents the login UI from flashing, especially after a redirect.
  if (isUserLoading) {
    return (
  ...
  // If loading is complete and there's no user, render the login UI.
  if (!user) {
    return (
  ...
  // If user is logged in but not yet redirected, show a loading screen
  // This is a fallback to prevent a blank screen
  return (
    <div className="flex min-h-screen items-center justify-center">
      <p>Redirecionando...</p>
    </div>
